...
<section class="head">
    ...
    <div class="chead cflex text-center">
        <div class="delimiter" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
            ...
            <h2 class="f-40 f-lg-24 c-neutral text-uppercase">Title of the News</h2>
        </div>
    </div>
</section>

<section class="dnews p-y-100">
    <div class="delimiter" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
        <div class="">
            <h2 class="f-28 f-lg-20 c-primary m-b-25">Title of the News</h2>
            ...
            <img src="{{ asset('/assets') }}/images/hero.png" class="m-y-50">
            <ul class="m-0 p-0">
